<!-- Sobre inspirado no site oficial -->
<section id="sobre" class="bg-shadow text-ice py-5">
  <div class="container">
    <h2 class="ordem-title text-blood mb-4 text-center">O Universo de Ordem Paranormal</h2>
  <p class="fs-5 text-center sobre-text animate-enigma-text">
    ...
    <p class="fs-6 text-center sobre-autor mt-3">
      O universo foi criado por Rafael Lange (Cellbit) e se expandiu para RPG de mesa, livros, quadrinhos e jogos digitais.
    </p>
  </div>
</section>
